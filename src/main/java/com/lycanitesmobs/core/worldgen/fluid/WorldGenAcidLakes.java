...
public class WorldGenAcidLakes extends WorldGenLakes implements IWorldGenBase {
    ...
    public WorldGenAcidLakes() {
        ...
        this.generateSurfaceChance = config.getDouble("WorldGen Chances", this.name + " Surface Chance", this.generateSurfaceChance, "Acid only generates on the surface when in WASTELAND and DEAD tagged biomes and not COLD or SNOWY.");
