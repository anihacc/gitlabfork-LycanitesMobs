...
public class WorldGenAcidLakes extends WorldGenLakes implements IWorldGenBase {
    public String name = "Acid Lakes";
    ...
    public WorldGenAcidLakes() {
        super(ObjectManager.getBlock("acid"));
        ...
        this.generateSurfaceChance = config.getDouble("WorldGen Chances", this.name + " Surface Chance", this.generateSurfaceChance, "Ooze only generates on the surface when in WASTELAND and DEAD tagged biomes and not COLD or SNOWY.");
    ...
    public void onWorldGen(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if(this.generateSurfaceChance > 0) {
            ...
            for(BiomeDictionary.Type type : biomeTypes) {
                ...
                if((type == BiomeDictionary.Type.WASTELAND) || (type == BiomeDictionary.Type.DEAD)) {
                    typeValid = true;
                }
            }
