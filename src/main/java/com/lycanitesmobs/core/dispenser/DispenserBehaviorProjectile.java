...
public class DispenserBehaviorProjectile extends ProjectileDispenseBehavior {
	protected ProjectileInfo projectileInfo;

	protected String oldProjectileName;
	protected Class<? extends EntityProjectileBase> oldProjectileClass;

	// ==================================================
	//                      Constructor
	// ==================================================
	public DispenserBehaviorProjectile(ProjectileInfo projectileInfo) {
		super();
		this.projectileInfo = projectileInfo;
	}

	public DispenserBehaviorProjectile(Class<? extends EntityProjectileBase> oldProjectileClass, String oldProjectileName) {
		super();
