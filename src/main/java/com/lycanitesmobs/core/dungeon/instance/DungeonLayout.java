...
public class DungeonLayout {
	...
	public SectorInstance start(Random random) {
		this.originConnector = new SectorConnector(this.dungeonInstance.originPos, null, 0, EnumFacing.HORIZONTALS[random.nextInt(EnumFacing.HORIZONTALS.length)]);
	...
	/**
	 * Second Underground Phase - Generates sectors on any open connectors.
	 * @param random The instance of Random to use.
