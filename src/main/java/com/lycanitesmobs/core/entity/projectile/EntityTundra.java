...
public class EntityTundra extends EntityProjectileBase {
    ...
    public void placeBlock(World world, BlockPos pos) {
        if(ObjectManager.getBlock("ooze") != null) {
            BlockState placedBlockBig = ObjectManager.getBlock("ooze").getDefaultState().withProperty(BlockLiquid.LEVEL, 4);
            BlockState placedBlock = ObjectManager.getBlock("ooze").getDefaultState().withProperty(BlockLiquid.LEVEL, 5);
