...
public class EntityPoisonRayEnd extends EntityProjectileLaserEnd {
    ...
    // ==================================================
 	//                   Constructors
 	// ==================================================
	public EntityPoisonRayEnd(EntityType<? extends EntityProjectileBase> entityType, World world) {
        super(entityType, world);
    }

    public EntityPoisonRayEnd(EntityType<? extends EntityProjectileBase> entityType, World world, double par2, double par4, double par6, EntityProjectileLaser laser) {
        super(entityType, world, par2, par4, par6, laser);
    }
    
    public EntityPoisonRayEnd(EntityType<? extends EntityProjectileBase> entityType, World world, LivingEntity shooter, EntityProjectileLaser laser) {
