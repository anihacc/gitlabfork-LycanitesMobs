...
public class EntityShadowfireBarrier extends BaseProjectileEntity {
    ...
    // ==================================================
 	//                   Constructors
 	// ==================================================
    public EntityShadowfireBarrier(World par1World) {
        super(par1World);
    }

    public EntityShadowfireBarrier(World par1World, EntityLivingBase par2EntityLivingBase) {
        super(par1World, par2EntityLivingBase);
    }

    public EntityShadowfireBarrier(World par1World, double par2, double par4, double par6) {
    ...
    public boolean onEntityLivingDamage(EntityLivingBase entityLiving) {
        ...
        if(entityLiving.isPotionApplicable(effectBlindness)) {
