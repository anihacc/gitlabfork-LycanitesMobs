...
public class Xaphan extends TameableCreatureEntity implements Enemy {
	private int nextSplash = 20;

    public Xaphan(EntityType<? extends Xaphan> entityType, Level world) {
	...
	public boolean isVulnerableTo(Entity entity) {
		if(entity instanceof Xaphan && this.getPlayerOwner() == ((Xaphan)entity).getPlayerOwner()) {
			return false;
		}
