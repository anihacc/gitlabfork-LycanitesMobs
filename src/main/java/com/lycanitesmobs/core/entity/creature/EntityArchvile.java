...
public class EntityArchvile extends TameableCreatureEntity implements IMob {
    // ==================================================
 	//                    Constructor
 	// ==================================================
    public EntityArchvile(EntityType<? extends EntityBehemoth> entityType, World world) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(this.nextCombatGoalIndex, new BuildAroundTargetGoal(this).setBlock(ObjectManager.getBlock("doomfire")).setTickRate(40).setRange(3).setTargetBit(TARGET_BITS.ATTACK).setEnclose(true));
