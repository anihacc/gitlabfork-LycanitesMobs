...
public class Jouste extends AgeableCreatureEntity {
    public Jouste(EntityType<? extends Jouste> entityType, Level world) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(this.nextFindTargetIndex++, new FindMasterGoal(this).setTargetClass(JousteAlpha.class).setSightCheck(false));
    ...
    public void onFirstSpawn() {
        ...
        if(alphaInfo != null) {
            ...
            if (this.getRandom().nextFloat() <= alphaChance) {
                JousteAlpha alpha = (JousteAlpha)CreatureManager.getInstance().getCreature("joustealpha").createEntity(this.getCommandSenderWorld());
	...
	public boolean canAttack(LivingEntity target) {
		if(target instanceof JousteAlpha)
			return false;
