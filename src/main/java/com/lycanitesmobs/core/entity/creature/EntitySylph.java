...
public class EntitySylph extends EntityCreatureTameable implements IMob {
    ...
    protected void initEntityAI() {
        ...
        this.field_70715_bh.addTask(3, new EntityAITargetAttack(this).setTargetClass(IGroupDemon.class));
        this.field_70715_bh.addTask(3, new EntityAITargetAttack(this).setTargetClass(IGroupShadow.class));
