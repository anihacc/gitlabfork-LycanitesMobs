...
public class EntitySylph extends EntityCreatureTameable implements IMob {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new AttackTargetingGoal(this).setTargetClass(IGroupDemon.class));
        this.targetSelector.addGoal(3, new AttackTargetingGoal(this).setTargetClass(IGroupShadow.class));
