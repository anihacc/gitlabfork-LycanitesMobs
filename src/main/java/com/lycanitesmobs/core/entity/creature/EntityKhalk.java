...
public class EntityKhalk extends EntityCreatureTameable implements IMob, IGroupFire, IGroupHeavy {
    ...
    protected void initEntityAI() {
        ...
        this.field_70714_bg.addTask(3, new EntityAIStayByWater(this).setSpeed(1.25D));
        ...
        this.field_70715_bh.addTask(6, new EntityAITargetAttack(this).setTargetClass(IGroupPlant.class));
