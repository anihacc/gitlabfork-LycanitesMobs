...
public class Cockatrice extends RideableCreatureEntity implements Enemy {
    ...
    public Cockatrice(EntityType<? extends Cockatrice> entityType, Level world) {
	...
	public void specialAttack() {
		...
		List<LivingEntity> possibleTargets = this.getCommandSenderWorld().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(distance, distance, distance), possibleTarget -> {
				if(!possibleTarget.isAlive()
						|| possibleTarget == Cockatrice.this
						|| Cockatrice.this.isEntityPassenger(possibleTarget, Cockatrice.this)
						|| Cockatrice.this.isAlliedTo(possibleTarget)
						|| !Cockatrice.this.canAttackType(possibleTarget.getType())
						|| !Cockatrice.this.canAttack(possibleTarget))
					return false;
			return true;
		});
