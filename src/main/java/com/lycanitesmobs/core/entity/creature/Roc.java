...
public class Roc extends RideableCreatureEntity implements Enemy {
    ...
    public Roc(EntityType<? extends Roc> entityType, Level world) {
    ...
    public void aiStep() {
        ...
        if(!this.getCommandSenderWorld().isClientSide && this.getControllingPassenger() == null && this.getPickupEntity() instanceof Creeper) {
            ((Creeper) this.getPickupEntity()).setTarget(null);
        }
    }
