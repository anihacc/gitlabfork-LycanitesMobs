...
public class SummoningPedestalScreen extends BaseContainerScreen {
    ...
    public SummoningPedestalScreen(EntityPlayer player, TileEntitySummoningPedestal summoningPedestal) {
        super(new SummoningPedestalContainer(summoningPedestal, player.inventory));
    ...
    protected void initControls() {
        ...
        this.buttonList.add(new MainTab(TAB_BUTTON_ID, buttonX, buttonY - 24));
